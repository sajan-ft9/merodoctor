...
<section class="n layout_padding">
    <div class="container">
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-4" >
                    <div class="card mb-4 shadow" style="height:45vh">
                        <div class="card-body text-center">
                            ...
                            <p class=" mb-1">{{ $user->user->email }}</p>
                            <p class=" mb-4">{{ $user->address }}</p>
                            <p class=" mb-4">Phone - {{ $user->phone }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route("patient.update", $user->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="phone" type="tel" class="text-muted form-control mb-0"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="address" type="text" class="text-muted form-control mb-0"
