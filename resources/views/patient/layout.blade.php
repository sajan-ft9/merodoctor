...
<body>
    <div id="app">
        ...
        <div id="sidebar"  style="position: fixed;display:none">
            <div>
                <div class="text-center">
                    <img src="{{ asset(auth()->user()->patients->image_path == "" ? "/images/client.jpg" : auth()->user()->patients->image_path) }}" alt="">
                </div>
                <div class="side-item py-2">
                    <a href="{{ route("patient.dashboard") }}">Dashboard</a>
                </div>
                <div class="side-item py-2">
                    <a href="{{ route('patient.appointment') }}">New Appointment</a>
                </div>
                <div class="side-item py-2">
                    <a href="{{ route('patient.show_appointment') }}">Appointments</a>
                </div>
                <div class="side-item py-2">
                    <a href="{{ route('patient.all_doctors') }}">Doctors</a>
                </div>
                <div class="side-item py-2">
        ...
        <main class="py-4" style="max-height:90vh; overflow-y:scroll">
