        ...
        <div id="sidebar" style="display: none">
            <div>
                <div class="text-center">
                    <img src="{{ asset(auth()->user()->doctors->image_path == "" ? '/images/client.jpg' :
                        auth()->user()->doctors->image_path) }}" alt="">
                </div>
                <div class="side-item py-2">
                    <a href="{{ route('doctor.dashboard') }}">Dashboard</a>
                </div>
                <div class="side-item py-2">
                    <a href="{{ route('doctor.show_appointment') }}">Pending Appointment</a>
                </div>
                <div class="side-item py-2">
                    <a href="{{ route('doctor.completed_appointment') }}">Completed Appointment</a>
                </div>
                <div class="side-item py-2">
